...
Status: **in progress** — CP1 (walking skeleton), CP2 (core motions & mode entries), CP3 (operator+motion reducer), CP4 (remaining Normal primitives), and CP5 (find & pair motions) complete; CP6 next.
