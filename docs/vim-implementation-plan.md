...
Status: **in progress** — CP1 (walking skeleton), CP2 (core motions & mode entries), CP3 (operator+motion reducer), CP4 (remaining Normal primitives), CP5 (find & pair motions), CP6 (Visual & VisualLine operators), CP7 (text objects), CP8 (search), and CP9 (ex commands) complete; CP10 next.
